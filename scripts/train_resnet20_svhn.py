...
Training script for a ResNet-20 model on SVHN (10 classes), with support for several coreset selection methods (craig, chvcoreset, random, chv_craig) or
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description='Coreset training with ResNet-20 on SVHN (10 classes)')

    # --- Define the command-line arguments ---
    parser.add_argument('--selection_method', type=str, default='chv_craig', 
    ...
    csv_file.close()
    print(f"\nTraining complete. Results have been saved to file: {filepath}")
